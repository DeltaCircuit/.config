...
sudo apt install fonts-firacode unzip git fzf wireplumber pipewire-media-session- pipewire-pulse pavucontrol fonts-noto-color-emoji pcmanfm libspa-0.2-bluetooth numlockx direnv fd-find -y
