...
local function set_wallpaper(s)
  ...
  if beautiful.wallpaper then
    ...
    local wallpaper = "/home/giri/IMG_20200209_064355.jpg"
...
local textWidget  = require('wifi');
awful.screen.connect_for_each_screen(function(s)
  -- Wallpaper
  set_wallpaper(s)

  -- Each screen has its own tag table.
  awful.tag({ " main ", " www ", " dev ", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
  ...
  -- Prompt
  awful.key({ modkey }, "r", function() awful.spawn("dmenu_run", false) end,
